...
public class SerMod {
    ...
    public SerMod(byte[] tmp)
    {
        ...
        MEM_total = (tmp[8] | tmp[9] << 8 | tmp[0] << 16 | (long)tmp[11] << 24 | (long)tmp[12] << 32 | (long)tmp[13] << 40 | (long)tmp[14] << 48 | (long)tmp[15] << 56);
        ...
        totalWload = Double.longBitsToDouble(tmp[40] | tmp[41] << 8 | tmp[42] << 16 | (long)tmp[43] << 24 | (long)tmp[44] << 32 | (long)tmp[45] << 40 | (long)tmp[46] << 48 | (long)tmp[47] << 56);
